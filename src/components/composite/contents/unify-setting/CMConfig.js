...
import {
    getCMConfig,
    getCubridBrokerConfig,
    getCubridConfig,
    setCMConfig,
    setCubridBrokerConfig,
    setCubridConfig
} from "@/utils/api";
...
import ConfirmAction from "@/components/common/ui/dialogs/ConfirmAction";
...
export default function (){
    ...
    const handleSaveConfig = ()=>{
        ...
        // setCMConfig({...getAPIParam(server), confdata: lines}).then(res =>{
        //     dispatch(setLoading(false))
        //     if(res.status) {
        //         removePanel()
        //     }
